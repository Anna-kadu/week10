...
const button = firstFunction();
console.log(button);

function sayResult1() {
	let result1 = document.getElementById('result1');
	result1.textContent = first;
}
...
const ply = multiply(x, y);
console.log(ply);

let result3 = document.getElementById('result3');
result3.textContent = ply;
...
const helloName = greet(firstName);
console.log(helloName);

let result4 = document.getElementById('result4');
result4.textContent = helloName;
...
const square = calculateArea(width, height);
console.log(square);

let result5 = document.getElementById('result5');
result5.textContent = square;
...
const onMessage = printMessage();
console.log(onMessage);

let result6 = document.getElementById('result6');
result6.textContent = onMessage;
...
let calculateDifference = function (h, j) {
	return h - j;
};

const result10 = calculateDifference(5, 3);
console.log(result10); //Выведет 2
...
let calculateProduct = function (k, l) {
	return k * l
}
...
const yourAge = calculateAge(thisYear, friendYearOfBirth);
console.log(yourAge);
...
const myAge = calculateAge(thisYear, myYearOfBirth);
console.log(myAge);
...
function degreeN(a, b) {
	return a ** b;
}

const result18 = degreeN(n, degree)
console.log("Результат: " + result18);